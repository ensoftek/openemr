...
INSERT INTO `clinical_rules` ( `id`, `pid`, `active_alert_flag`, `passive_alert_flag`, `cqm_flag`, `cqm_nqf_code`, `cqm_pqri_code`, `amc_flag`, `amc_code`, `patient_reminder_flag`,  `amc_2011_flag`,  `amc_2014_flag`, `amc_code_2014` ) VALUES ('image_results_amc', 0, 0, 0, 1, '', '', 0, '', 0, 0, 1, '170.314(g)(1)/(2)-20');
...
INSERT INTO `clinical_rules` ( `id`, `pid`, `active_alert_flag`, `passive_alert_flag`, `cqm_flag`, `cqm_nqf_code`, `cqm_pqri_code`, `amc_flag`, 
	`amc_code`, `patient_reminder_flag`,  `amc_2011_flag`,  `amc_2014_flag`, `amc_code_2014`) VALUES ('family_health_history_amc', 0, 0, 0, 1, '', '', 0, '', 0, 0, 1, '170.314(g)(1)/(2)-21');
-- 170.314(g)(1)/(2)-22 Electronic Notes
INSERT INTO `clinical_rules` ( `id`, `pid`, `active_alert_flag`, `passive_alert_flag`, `cqm_flag`, `cqm_nqf_code`, `cqm_pqri_code`, `amc_flag`, `amc_code`, `patient_reminder_flag`,  `amc_2011_flag`,  `amc_2014_flag`, `amc_code_2014` ) VALUES ('electronic_notes_amc', 0, 0, 0, 1, '', '', 0, '', 0, 0, 1, '170.314(g)(1)/(2)-22');
-- --------------------------------------------------------
